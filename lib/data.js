...
export async function getHomeData() {
  ...
  const [heroRes, servicesRes, projectsRes, blogRes, expRes, hwwRes, partnersRes] = await Promise.allSettled([
    // 1. Hero (Home)
    pool.query(`
      SELECT h.*, 
  ...
  return { hero, services, projects, posts, experience, howWeWork, partnerships }
}
