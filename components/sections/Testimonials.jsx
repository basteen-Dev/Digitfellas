                                    ...
                                    <div className="relative w-12 h-12">
                                        {testimonial.client_image_url ? (
                                            <Image
                                                ...
                                                fill
                                                className="rounded-full object-cover ring-2 ring-white/5"
                                            />
                                        ) : (
                                            <div className="w-full h-full rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-bold text-lg">
                                                {testimonial.client_name.charAt(0)}
                                            </div>
                                        )}
                                    </div>
                                    <div>
                                        <div className="font-bold text-white group-hover:text-primary transition-colors">{testimonial.client_name}</div>
